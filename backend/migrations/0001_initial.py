# Generated by Django 2.2.1 on 2019-05-04 20:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('middle_name', models.CharField(max_length=14, verbose_name='middle name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(db_column='emp_no', on_delete=django.db.models.deletion.CASCADE, to='backend.Employee', verbose_name='employee')),
            ],
            options={
                'verbose_name': 'title',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_date', models.DateField(verbose_name='from')),
                ('to_date', models.DateField(verbose_name='to')),
                ('department', models.ForeignKey(db_column='dept_no', on_delete=django.db.models.deletion.CASCADE, to='backend.Department', verbose_name='department')),
                ('employee', models.ForeignKey(db_column='emp_no', on_delete=django.db.models.deletion.CASCADE, to='backend.Employee', verbose_name='employee')),
            ],
            options={
